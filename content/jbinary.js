!function(a) {
    ...
    function h(a, d) {
        return c(a, h) ? a.as(d) : (c(a, b) || (a = new b(a, void 0, void 0, d ? d["jBinary.littleEndian"] : void 0)),
        c(this, h) ? (this.view = a, this.view.seek(0), this.contexts = [], this.as(d, !0)) : new h(a, d));
    }
    function i(a) {
    ...
    function j(a) {
        return e(j.prototype, a, {
            createProperty: function() {
                ...
                return b.getBaseType && (b.baseType = b.binary.getType(b.getBaseType(b.binary.contexts[0]))),
                b;
            }
        });
    }
        ...
        function b(a) {
            ...
            for (e = a.length, c = 0, b = ""; e > c; ) {
                ...
                if (g = a.charCodeAt(c++), c == e) {
                    b += d.charAt(f >> 2), b += d.charAt((3 & f) << 4 | (240 & g) >> 4), b += d.charAt((15 & g) << 2),
                    b += "=";
                    break;
                }
                h = a.charCodeAt(c++), b += d.charAt(f >> 2), b += d.charAt((3 & f) << 4 | (240 & g) >> 4),
                b += d.charAt((15 & g) << 2 | (192 & h) >> 6), b += d.charAt(63 & h);
            }
            return b;
        }
        function c(a) {
    ...
    n._getCached = function(a, b, c) {
        ...
        var c = b ? this : e(this);
        return a = a || o, c.typeSet = a === o || o.isPrototypeOf(a) ? a : e(o, a), c.cacheKey = r,
        c.cacheKey = c._getCached(a, function() {
            return r + "." + ++s;
        }, !0), c;
    }, n.seek = function(a, b) {
        ...
        return d && !c(a, i) && (d.name = "object" == typeof a ? c(a, Array) ? a[0] + "(" + a.slice(1).join(", ") + ")" : "object" : String(a)),
        d;
    ...
    h.loadData = g(function(b, d) {
        ...
        if (c(b, a.Blob)) {
            ...
            if ("string" != typeof b) d(new TypeError("Unsupported source type.")); else if (e = b.match(/^data:(.+?)(;base64)?,(.*)$/)) try {
                var g = e[2], h = e[3];
                d(null, (g ? atob : decodeURIComponent)(h));
            } catch (i) {
                d(i);
            } else if ("XMLHttpRequest" in a) {
                var j = new XMLHttpRequest();
                j.open("GET", b, !0), "responseType" in j ? j.responseType = "arraybuffer" : "overrideMimeType" in j ? j.overrideMimeType("text/plain; charset=x-user-defined") : j.setRequestHeader("Accept-Charset", "x-user-defined"),
                "onload" in j || (j.onreadystatechange = function() {
                ...
                j.onload = function() {
                    return 0 !== this.status && 200 !== this.status ? k("HTTP Error #" + this.status + ": " + this.statusText) : ("response" in this || (this.response = new VBArray(this.responseBody).toArray()),
                    void d(null, this.response));
                }, j.onerror = function() {
                    k("Network error.");
                }, j.send(null);
    ...
    }, n.toRawBytes = function() {
        return this.seek(0, function() {return this.view.getBytes();});
    };
    if (k) {
    ...
    return n.saveAs = g(function(a, b, c) {
        if ("string" == typeof a) {
            ...
            }), a) : k ? (t.parentNode || k.body.appendChild(t), t.href = this.toURI(b), t.download = a,
            t.click(), t.href = t.download = "") : c(new TypeError("Saving from Web Worker is not supported.")),
            c();
